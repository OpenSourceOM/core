...
- Third-party dependencies (report upstream; we will track CVEs). Dependabot opens weekly PRs. CI runs [`govulncheck`](https://pkg.go.dev/golang.org/x/vuln/cmd/govulncheck) and [CodeQL](https://codeql.github.com/).
